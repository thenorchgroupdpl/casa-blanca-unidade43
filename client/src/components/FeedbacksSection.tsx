...
export default function FeedbacksSection() {
  ...
  // Monta URL do Google Maps para ver todas as avaliações
  const googleReviewsUrl = google_place_id
  ...
  return (
    <section id="feedbacks" className="py-20 bg-lp-surface-soft relative" style={sectionBgStyle}>
      ...
      <div className="relative z-10">
        ...
        {/* Google Badge / CTA — link clicável para ver avaliações no Google Maps */}
        {googleReviewsUrl && (
          <motion.div
          ...
          >
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-lp-text-faint border border-lp-border hover:opacity-80 active:scale-95 transition-all"
              style={ctaBtnStyle}
            >
