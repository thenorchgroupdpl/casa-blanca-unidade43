...
// ============================================
// PRESET 19 — ASSISTÊNCIA TÉCNICA (Tech Blue)
// ============================================

const assistenciaTecnica: DesignPreset = {
  id: "assistencia-tecnica",
  name: "Tech Repair",
  description: "Azul tecnológico com fundo escuro. Profissional e confiável.",
  niche: "Assistência técnica, eletrônicos, informática",
  colors: { primary: "#3B82F6", background: "#0f172a", accent: "#1e293b" },
  themeColors: {
    primary: "#3B82F6",
    background: "#0f172a",
    foreground: "#f8fafc",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(15,23,42,0.85)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(59,130,246,0.1)",
      locationBoxText: "#94a3b8",
      locationBoxIcon: "#3B82F6",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      scheduleBoxBg: "rgba(34,197,94,0.15)",
      scheduleBoxText: "#22c55e",
      ...
      badgeOpenColor: "#22c55e",
      badgeClosedColor: "#ef4444",
      headline: "Consertamos Qualquer Dispositivo",
      headlineFont: "Inter",
      headlineFontSize: 56,
      headlineFontWeight: "800",
      headlineColor: "#f8fafc",
      subheadline: "Assistência técnica especializada com garantia",
      subheadlineFont: "Inter",
      subheadlineFontSize: 20,
      subheadlineFontWeight: "400",
      ...
      ctaTextColor: "#ffffff",
      ctaGradient: false,
      ctaGradientEnd: "#2563eb",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 65,
      bgOverlayColor: "#0f172a",
      bgFallbackColor: "#0f172a",
    },
    products: {
      headline: "Nossos Serviços",
      subheadline: "Soluções para todos os dispositivos",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Inter",
      headlineFontSize: 40,
      ...
      cardPriceColor: "#3B82F6",
      cardDescColor: "#94a3b8",
      cardUnitColor: "#64748b",
      cardBorderRadius: 8,
      cardBorderColor: "#334155",
      cardBorderWidth: 1,
      cardButtonText: "Solicitar",
    ...
    about: {
      preHeadline: "SOBRE A EMPRESA",
      preHeadlineFont: "Inter",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "600",
      preHeadlineColor: "#3B82F6",
      headline: "Quem Somos",
      headlineFont: "Inter",
      headlineFontSize: 48,
      headlineFontWeight: "800",
      ...
      ownerNameFontSize: 20,
      ownerNameFontWeight: "700",
      ownerNameColor: "#f8fafc",
      ownerTitleColor: "#94a3b8",
      storytellingFont: "Inter",
      storytellingFontSize: 18,
      storytellingFontWeight: "400",
      storytellingColor: "#cbd5e1",
    ...
    menu: {
      menuSectionTitle: "Serviços",
      panelBgColor: "#0f172a",
      panelOverlayOpacity: 80,
      panelOverlayColor: "#0f172a",
      headerTextColor: "#f8fafc",
      searchBorderColor: "#334155",
      searchBgColor: "#1e293b",
      searchTextColor: "#f8fafc",
      searchPlaceholderColor: "#64748b",
      searchIconColor: "#64748b",
      categoryNameColor: "#3B82F6",
      filterActiveBgColor: "#3B82F6",
      filterActiveTextColor: "#ffffff",
      filterInactiveBgColor: "#334155",
      filterInactiveTextColor: "#94a3b8",
      cardBgColor: "#1e293b",
      cardBorderColor: "#334155",
      cardBorderWidth: 1,
      cardBorderRadius: 8,
      ...
      cardButtonTextColor: "#ffffff",
      modalBgColor: "#1e293b",
      modalNameColor: "#f8fafc",
      modalUnitColor: "#64748b",
      modalPriceColor: "#3B82F6",
      modalDescColor: "#94a3b8",
      modalCtaBgColor: "#3B82F6",
      modalCtaTextColor: "#ffffff",
      modalCtaFont: "Inter",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "600",
      qtyLabelColor: "#94a3b8",
      qtyBtnBgColor: "#334155",
      qtyBtnTextColor: "#f8fafc",
      qtyNumberColor: "#f8fafc",
    },
    toast: {
      bgColor: "#1e293b",
      borderColor: "#3B82F6",
      ...
      iconCheckColor: "#ffffff",
      iconBgColor: "#3B82F6",
      closeButtonColor: "#64748b",
    },
    cartLanding: {
      modalBgColor: "#0f172a",
      headerTextColor: "#f8fafc",
      headerCloseColor: "#64748b",
      headerIconColor: "#3B82F6",
      itemBgColor: "#1e293b",
      itemBorderColor: "#334155",
      itemNameColor: "#f8fafc",
      itemPriceColor: "#3B82F6",
      itemTrashColor: "#ef4444",
      qtyBtnBgColor: "#334155",
      qtyBtnTextColor: "#f8fafc",
      qtyNumberColor: "#f8fafc",
      obsBgColor: "#1e293b",
      obsBorderColor: "#334155",
      obsTextColor: "#94a3b8",
      totalLabelColor: "#94a3b8",
      totalValueColor: "#3B82F6",
      ctaBgColor: "#3B82F6",
      ctaTextColor: "#ffffff",
      clearLinkColor: "#ef4444",
    },
    ...
    reviews: {
      ...
      headlineFontWeight: "800",
      headlineColor: "#f8fafc",
      ratingNumberColor: "#f8fafc",
      ratingTotalColor: "#64748b",
      cardBgColor: "#1e293b",
      cardNameColor: "#f8fafc",
      cardDateColor: "#64748b",
    ...
    info: {
      ...
      headlineFontWeight: "800",
      headlineColor: "#f8fafc",
      subheadline: "Estamos prontos para atender você",
      subheadlineFont: "Inter",
      subheadlineFontSize: 18,
      subheadlineFontWeight: "400",
      subheadlineColor: "#94a3b8",
      headline1: "Fale Conosco",
      subheadline1: "Estamos prontos para atender você",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 40,
      mapPinColor: "#3B82F6",
      mapBtnBgColor: "#3B82F6",
      mapBtnTextColor: "#ffffff",
      mapBtnFont: "Inter",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "600",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#3B82F6",
      addressIconBgColor: "#334155",
      addressTitleColor: "#f8fafc",
      addressTextColor: "#94a3b8",
      addressFont: "Inter",
      addressFontSize: 14,
      addressFontWeight: "400",
      phoneIconColor: "#3B82F6",
      phoneIconBgColor: "#334155",
      phoneTitleColor: "#f8fafc",
      phoneTextColor: "#94a3b8",
      phoneFont: "Inter",
      phoneFontSize: 14,
      phoneFontWeight: "400",
      hoursIconColor: "#3B82F6",
      hoursIconBgColor: "#334155",
      hoursTitleColor: "#f8fafc",
      hoursContentColor: "#94a3b8",
      hoursLinkColor: "#3B82F6",
      hoursLinkFont: "Inter",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "500",
      scheduleModalBg: "#1e293b",
      scheduleModalTitleColor: "#f8fafc",
      scheduleModalTextColor: "#94a3b8",
      scheduleModalStatusColor: "#22c55e",
      scheduleModalHighlightBg: "#334155",
      socialBtnBgColor: "#334155",
      socialIconColor: "#3B82F6",
      socialBtnTextColor: "#94a3b8",
      socialBtnShowText: false,
      socialInstagramEnabled: true,
      socialFacebookEnabled: true,
      socialYoutubeEnabled: false,
    ...
    sectionColors: {},
    whatsapp: {
      popupTitle: "Precisa de ajuda técnica?",
      buttonText: "Falar com Técnico",
      popupBg: "#1e293b",
...
// ============================================
// PRESET 20 — OFICINA MECÂNICA (Steel Orange)
// ============================================

const oficinaMecanica: DesignPreset = {
  id: "oficina-mecanica",
  name: "Auto Garage",
  description: "Laranja industrial com fundo escuro. Força e confiança.",
  niche: "Oficina mecânica, autopeças, funilaria",
  colors: { primary: "#F97316", background: "#171717", accent: "#262626" },
  themeColors: {
    primary: "#F97316",
    background: "#171717",
    foreground: "#fafafa",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(23,23,23,0.9)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(249,115,22,0.1)",
      locationBoxText: "#a3a3a3",
      locationBoxIcon: "#F97316",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      scheduleBoxBg: "rgba(34,197,94,0.15)",
      scheduleBoxText: "#22c55e",
      ...
      badgeOpenColor: "#22c55e",
      badgeClosedColor: "#ef4444",
      headline: "Mecânica de Confiança",
      headlineFont: "Barlow",
      headlineFontSize: 60,
      headlineFontWeight: "800",
      headlineColor: "#fafafa",
      subheadline: "Seu carro em boas mãos — diagnóstico e reparo profissional",
      subheadlineFont: "Barlow",
      subheadlineFontSize: 20,
      subheadlineFontWeight: "400",
      subheadlineColor: "#a3a3a3",
      ctaText: "Agendar Serviço",
      ctaBgColor: "#F97316",
      ctaTextColor: "#ffffff",
      ctaGradient: false,
      ctaGradientEnd: "#ea580c",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 60,
      bgOverlayColor: "#171717",
      bgFallbackColor: "#171717",
    },
    products: {
      headline: "Nossos Serviços",
      subheadline: "Manutenção preventiva e corretiva",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Barlow",
      headlineFontSize: 40,
      ...
      subheadlineColor: "#a3a3a3",
      cardBgColor: "#262626",
      cardNameColor: "#fafafa",
      cardPriceColor: "#F97316",
      cardDescColor: "#a3a3a3",
      cardUnitColor: "#737373",
      cardBorderRadius: 8,
      cardBorderColor: "#404040",
      cardBorderWidth: 1,
      cardButtonText: "Agendar",
      cardButtonBgColor: "#F97316",
      cardButtonTextColor: "#ffffff",
      bgColor: "#171717",
      bgGradient: false,
    ...
    about: {
      preHeadline: "SOBRE A OFICINA",
      preHeadlineFont: "Barlow",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "600",
      preHeadlineColor: "#F97316",
      headline: "Nossa História",
      headlineFont: "Barlow",
      headlineFontSize: 48,
      headlineFontWeight: "800",
      headlineColor: "#fafafa",
      imageRadius: 12,
      ownerNameFont: "Barlow",
      ownerNameFontSize: 20,
      ownerNameFontWeight: "700",
      ownerNameColor: "#fafafa",
      ownerTitleColor: "#a3a3a3",
      storytellingFont: "Barlow",
      storytellingFontSize: 18,
      storytellingFontWeight: "400",
      storytellingColor: "#d4d4d4",
    ...
    menu: {
      ...
      panelBgColor: "#171717",
      panelOverlayOpacity: 80,
      panelOverlayColor: "#171717",
      headerTextColor: "#fafafa",
      searchBorderColor: "#404040",
      searchBgColor: "#262626",
      searchTextColor: "#fafafa",
      searchPlaceholderColor: "#737373",
      searchIconColor: "#737373",
      categoryNameColor: "#F97316",
      filterActiveBgColor: "#F97316",
      filterActiveTextColor: "#ffffff",
      filterInactiveBgColor: "#404040",
      filterInactiveTextColor: "#a3a3a3",
      cardBgColor: "#262626",
      cardBorderColor: "#404040",
      cardBorderWidth: 1,
      cardBorderRadius: 8,
      ...
      cardButtonTextColor: "#ffffff",
      modalBgColor: "#262626",
      modalNameColor: "#fafafa",
      modalUnitColor: "#737373",
      modalPriceColor: "#F97316",
      modalDescColor: "#a3a3a3",
      modalCtaBgColor: "#F97316",
      modalCtaTextColor: "#ffffff",
      modalCtaFont: "Barlow",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "600",
      qtyLabelColor: "#a3a3a3",
      qtyBtnBgColor: "#404040",
      qtyBtnTextColor: "#fafafa",
      qtyNumberColor: "#fafafa",
    },
    toast: {
      bgColor: "#262626",
      borderColor: "#F97316",
      ...
      iconCheckColor: "#ffffff",
      iconBgColor: "#F97316",
      closeButtonColor: "#737373",
    },
    cartLanding: {
      modalBgColor: "#171717",
      headerTextColor: "#fafafa",
      headerCloseColor: "#737373",
      headerIconColor: "#F97316",
      itemBgColor: "#262626",
      itemBorderColor: "#404040",
      itemNameColor: "#fafafa",
      itemPriceColor: "#F97316",
      itemTrashColor: "#ef4444",
      qtyBtnBgColor: "#404040",
      qtyBtnTextColor: "#fafafa",
      qtyNumberColor: "#fafafa",
      obsBgColor: "#262626",
      obsBorderColor: "#404040",
      obsTextColor: "#a3a3a3",
      totalLabelColor: "#a3a3a3",
      totalValueColor: "#F97316",
      ctaBgColor: "#F97316",
      ctaTextColor: "#ffffff",
      clearLinkColor: "#ef4444",
    },
    ...
    reviews: {
      headline: "Avaliações dos nossos clientes",
      isVisible: true,
      starColor: "#F97316",
      label: "DEPOIMENTOS",
      labelFont: "Barlow",
      ...
      headlineFontWeight: "800",
      headlineColor: "#fafafa",
      ratingNumberColor: "#fafafa",
      ratingTotalColor: "#737373",
      cardBgColor: "#262626",
      cardNameColor: "#fafafa",
      cardDateColor: "#737373",
    ...
    info: {
      ...
      labelFontWeight: "600",
      labelColor: "#F97316",
      headline: "Visite Nossa Oficina",
      headlineFont: "Barlow",
      headlineFontSize: 40,
      headlineFontWeight: "800",
      headlineColor: "#fafafa",
      subheadline: "Atendimento rápido e profissional",
      subheadlineFont: "Barlow",
      subheadlineFontSize: 18,
      subheadlineFontWeight: "400",
      subheadlineColor: "#a3a3a3",
      headline1: "Visite Nossa Oficina",
      subheadline1: "Atendimento rápido e profissional",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 40,
      mapPinColor: "#F97316",
      mapBtnBgColor: "#F97316",
      mapBtnTextColor: "#ffffff",
      mapBtnFont: "Barlow",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "600",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#F97316",
      addressIconBgColor: "#404040",
      addressTitleColor: "#fafafa",
      addressTextColor: "#a3a3a3",
      addressFont: "Barlow",
      addressFontSize: 14,
      addressFontWeight: "400",
      phoneIconColor: "#F97316",
      phoneIconBgColor: "#404040",
      phoneTitleColor: "#fafafa",
      phoneTextColor: "#a3a3a3",
      phoneFont: "Barlow",
      phoneFontSize: 14,
      phoneFontWeight: "400",
      hoursIconColor: "#F97316",
      hoursIconBgColor: "#404040",
      hoursTitleColor: "#fafafa",
      hoursContentColor: "#a3a3a3",
      hoursLinkColor: "#F97316",
      hoursLinkFont: "Barlow",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "500",
      scheduleModalBg: "#262626",
      scheduleModalTitleColor: "#fafafa",
      scheduleModalTextColor: "#a3a3a3",
      scheduleModalStatusColor: "#22c55e",
      scheduleModalHighlightBg: "#404040",
      socialBtnBgColor: "#404040",
      socialIconColor: "#F97316",
      socialBtnTextColor: "#a3a3a3",
      socialBtnShowText: false,
      socialInstagramEnabled: true,
      socialFacebookEnabled: true,
      socialYoutubeEnabled: true,
      sectionBgColor: "#171717",
      cardsBgColor: "#262626",
      bgOverlayOpacity: 0,
      bgOverlayColor: "#000000",
    ...
    sectionColors: {},
    whatsapp: {
      popupTitle: "Precisa de um orçamento?",
      buttonText: "Falar com a Oficina",
      popupBg: "#262626",
      popupTextColor: "#fafafa",
      buttonBg: "#F97316",
      buttonTextColor: "#ffffff",
    },
  },
...
// ============================================
// PRESET 21 — SALÃO DE BELEZA (Rose Gold)
// ============================================

const salaoDebeleza: DesignPreset = {
  id: "salao-de-beleza",
  name: "Beauty Rose",
  description: "Rose gold elegante com fundo claro. Sofisticação e feminilidade.",
  niche: "Salão de beleza, barbearia, estética",
  colors: { primary: "#be185d", background: "#fdf2f8", accent: "#fce7f3" },
  themeColors: {
    primary: "#be185d",
    background: "#fdf2f8",
    foreground: "#1c1917",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(253,242,248,0.9)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(190,24,93,0.08)",
      locationBoxText: "#78716c",
      locationBoxIcon: "#be185d",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      scheduleBoxBg: "rgba(34,197,94,0.1)",
      scheduleBoxText: "#16a34a",
      scheduleBoxIcon: "#16a34a",
      scheduleLabel: "",
      scheduleBoxGlassmorphism: true,
      badgeOpenColor: "#16a34a",
      badgeClosedColor: "#dc2626",
      headline: "Beleza que Transforma",
      headlineFont: "Playfair Display",
      headlineFontSize: 56,
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      subheadline: "Realce sua beleza natural com nossos profissionais",
      subheadlineFont: "Nunito",
      subheadlineFontSize: 20,
      subheadlineFontWeight: "400",
      subheadlineColor: "#78716c",
      ctaText: "Agendar Horário",
      ctaBgColor: "#be185d",
      ctaTextColor: "#ffffff",
      ctaGradient: false,
      ctaGradientEnd: "#9f1239",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 20,
      bgOverlayColor: "#fdf2f8",
      bgFallbackColor: "#fdf2f8",
    },
    products: {
      headline: "Nossos Serviços",
      subheadline: "Tratamentos exclusivos para você",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Playfair Display",
      headlineFontSize: 40,
      ...
      subheadlineColor: "#78716c",
      cardBgColor: "#ffffff",
      cardNameColor: "#1c1917",
      cardPriceColor: "#be185d",
      cardDescColor: "#78716c",
      cardUnitColor: "#a8a29e",
      cardBorderRadius: 16,
      cardBorderColor: "#fce7f3",
      cardBorderWidth: 1,
      cardButtonText: "Agendar",
      cardButtonBgColor: "#be185d",
      cardButtonTextColor: "#ffffff",
      bgColor: "#fdf2f8",
      bgGradient: false,
    ...
    about: {
      preHeadline: "NOSSA HISTÓRIA",
      preHeadlineFont: "Nunito",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "600",
      preHeadlineColor: "#be185d",
      headline: "Sobre o Salão",
      headlineFont: "Playfair Display",
      headlineFontSize: 48,
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      ...
      ownerNameFontSize: 20,
      ownerNameFontWeight: "700",
      ownerNameColor: "#1c1917",
      ownerTitleColor: "#78716c",
      storytellingFont: "Nunito",
      storytellingFontSize: 18,
      storytellingFontWeight: "400",
      storytellingColor: "#44403c",
    ...
    menu: {
      menuSectionTitle: "Serviços",
      panelBgColor: "#fdf2f8",
      panelOverlayOpacity: 90,
      panelOverlayColor: "#fdf2f8",
      headerTextColor: "#1c1917",
      searchBorderColor: "#fce7f3",
      searchBgColor: "#ffffff",
      searchTextColor: "#1c1917",
      searchPlaceholderColor: "#a8a29e",
      searchIconColor: "#a8a29e",
      categoryNameColor: "#be185d",
      filterActiveBgColor: "#be185d",
      filterActiveTextColor: "#ffffff",
      filterInactiveBgColor: "#fce7f3",
      filterInactiveTextColor: "#78716c",
      cardBgColor: "#ffffff",
      cardBorderColor: "#fce7f3",
      cardBorderWidth: 1,
      cardBorderRadius: 16,
      ...
      cardButtonTextColor: "#ffffff",
      modalBgColor: "#ffffff",
      modalNameColor: "#1c1917",
      modalUnitColor: "#a8a29e",
      modalPriceColor: "#be185d",
      modalDescColor: "#78716c",
      modalCtaBgColor: "#be185d",
      modalCtaTextColor: "#ffffff",
      modalCtaFont: "Nunito",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "600",
      qtyLabelColor: "#78716c",
      qtyBtnBgColor: "#fce7f3",
      qtyBtnTextColor: "#be185d",
      qtyNumberColor: "#1c1917",
    },
    toast: {
      bgColor: "#ffffff",
      borderColor: "#be185d",
    ...
    cartLanding: {
      modalBgColor: "#fdf2f8",
      headerTextColor: "#1c1917",
      headerCloseColor: "#a8a29e",
      headerIconColor: "#be185d",
      itemBgColor: "#ffffff",
      itemBorderColor: "#fce7f3",
      itemNameColor: "#1c1917",
      itemPriceColor: "#be185d",
      itemTrashColor: "#dc2626",
      qtyBtnBgColor: "#fce7f3",
      qtyBtnTextColor: "#be185d",
      qtyNumberColor: "#1c1917",
      obsBgColor: "#ffffff",
      obsBorderColor: "#fce7f3",
      obsTextColor: "#78716c",
      totalLabelColor: "#78716c",
      totalValueColor: "#be185d",
      ctaBgColor: "#be185d",
      ctaTextColor: "#ffffff",
      clearLinkColor: "#dc2626",
    },
    cartMenu: {
      modalBgColor: "#fdf2f8",
      headerTextColor: "#1c1917",
    ...
    reviews: {
      headline: "O que nossas clientes dizem",
      isVisible: true,
      starColor: "#be185d",
      label: "AVALIAÇÕES",
      labelFont: "Nunito",
      ...
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      ratingNumberColor: "#1c1917",
      ratingTotalColor: "#a8a29e",
      cardBgColor: "#ffffff",
      cardNameColor: "#1c1917",
      cardDateColor: "#a8a29e",
    ...
    info: {
      ...
      subheadlineFontWeight: "400",
      subheadlineColor: "#78716c",
      headline1: "Visite Nosso Salão",
      subheadline1: "Estamos esperando por você",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 20,
      mapPinColor: "#be185d",
      mapBtnBgColor: "#be185d",
      mapBtnTextColor: "#ffffff",
      mapBtnFont: "Nunito",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "600",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#be185d",
      addressIconBgColor: "#fce7f3",
      addressTitleColor: "#1c1917",
      addressTextColor: "#78716c",
      addressFont: "Nunito",
      addressFontSize: 14,
      addressFontWeight: "400",
      phoneIconColor: "#be185d",
      phoneIconBgColor: "#fce7f3",
      phoneTitleColor: "#1c1917",
      phoneTextColor: "#78716c",
      phoneFont: "Nunito",
      phoneFontSize: 14,
      phoneFontWeight: "400",
      hoursIconColor: "#be185d",
      hoursIconBgColor: "#fce7f3",
      hoursTitleColor: "#1c1917",
      hoursContentColor: "#78716c",
      hoursLinkColor: "#be185d",
      hoursLinkFont: "Nunito",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "500",
      scheduleModalBg: "#ffffff",
      scheduleModalTitleColor: "#1c1917",
      scheduleModalTextColor: "#78716c",
      scheduleModalStatusColor: "#16a34a",
      scheduleModalHighlightBg: "#fce7f3",
      socialBtnBgColor: "#fce7f3",
      socialIconColor: "#be185d",
      socialBtnTextColor: "#78716c",
      socialBtnShowText: false,
      socialInstagramEnabled: true,
      socialFacebookEnabled: true,
      socialYoutubeEnabled: false,
    ...
    sectionColors: {},
    whatsapp: {
      popupTitle: "Quer agendar um horário?",
      buttonText: "Agendar pelo WhatsApp",
      popupBg: "#ffffff",
      popupTextColor: "#1c1917",
      buttonBg: "#be185d",
      buttonTextColor: "#ffffff",
    },
  },
...
// ============================================
// PRESET 22 — PET SHOP (Teal Paw)
// ============================================

const petShop: DesignPreset = {
  id: "pet-shop",
  name: "Pet Care",
  description: "Verde-azulado vibrante com fundo claro. Amigável e acolhedor.",
  niche: "Pet shop, clínica veterinária, banho e tosa",
  colors: { primary: "#0d9488", background: "#f0fdfa", accent: "#ccfbf1" },
  themeColors: {
    primary: "#0d9488",
    background: "#f0fdfa",
    foreground: "#1c1917",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(240,253,250,0.9)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(13,148,136,0.08)",
      locationBoxText: "#78716c",
      locationBoxIcon: "#0d9488",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      scheduleBoxBg: "rgba(34,197,94,0.1)",
      scheduleBoxText: "#16a34a",
      ...
      badgeOpenColor: "#16a34a",
      badgeClosedColor: "#dc2626",
      headline: "Cuidado e Amor para seu Pet",
      headlineFont: "Quicksand",
      headlineFontSize: 56,
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      subheadline: "Tudo que seu bichinho precisa em um só lugar",
      subheadlineFont: "Quicksand",
      subheadlineFontSize: 20,
      subheadlineFontWeight: "500",
      subheadlineColor: "#78716c",
      ctaText: "Ver Produtos",
      ctaBgColor: "#0d9488",
      ctaTextColor: "#ffffff",
      ctaGradient: false,
      ctaGradientEnd: "#0f766e",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 15,
      bgOverlayColor: "#f0fdfa",
      bgFallbackColor: "#f0fdfa",
    },
    products: {
      headline: "Produtos & Serviços",
      subheadline: "O melhor para o seu companheiro",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Quicksand",
      headlineFontSize: 40,
      ...
      bgOverlayColor: "#000000",
      viewAllBgColor: "transparent",
      viewAllTextColor: "#0d9488",
      viewAllFont: "Quicksand",
      viewAllFontSize: 14,
      viewAllFontWeight: "600",
      viewAllLabel: "Ver todos",
    ...
    about: {
      preHeadline: "SOBRE NÓS",
      preHeadlineFont: "Quicksand",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "600",
      preHeadlineColor: "#0d9488",
      headline: "Nossa Paixão por Animais",
      headlineFont: "Quicksand",
      headlineFontSize: 48,
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      imageRadius: 20,
      ownerNameFont: "Quicksand",
      ownerNameFontSize: 20,
      ownerNameFontWeight: "700",
      ownerNameColor: "#1c1917",
      ownerTitleColor: "#78716c",
      storytellingFont: "Quicksand",
      storytellingFontSize: 18,
      storytellingFontWeight: "400",
      storytellingColor: "#44403c",
      signatureColor: "#0d9488",
      showSignature: true,
      bgOverlayOpacity: 0,
      bgOverlayColor: "#000000",
      bgFallbackColor: "#f0fdfa",
    ...
    menu: {
      menuSectionTitle: "Catálogo",
      panelBgColor: "#f0fdfa",
      panelOverlayOpacity: 90,
      panelOverlayColor: "#f0fdfa",
      headerTextColor: "#1c1917",
      searchBorderColor: "#ccfbf1",
      searchBgColor: "#ffffff",
      searchTextColor: "#1c1917",
      searchPlaceholderColor: "#a8a29e",
      searchIconColor: "#a8a29e",
      categoryNameColor: "#0d9488",
      filterActiveBgColor: "#0d9488",
      filterActiveTextColor: "#ffffff",
      filterInactiveBgColor: "#ccfbf1",
      filterInactiveTextColor: "#78716c",
      cardBgColor: "#ffffff",
      cardBorderColor: "#ccfbf1",
      cardBorderWidth: 1,
      ...
      modalNameColor: "#1c1917",
      modalUnitColor: "#a8a29e",
      modalPriceColor: "#0d9488",
      modalDescColor: "#78716c",
      modalCtaBgColor: "#0d9488",
      modalCtaTextColor: "#ffffff",
      modalCtaFont: "Quicksand",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "600",
      qtyLabelColor: "#78716c",
      qtyBtnBgColor: "#ccfbf1",
      qtyBtnTextColor: "#0d9488",
      qtyNumberColor: "#1c1917",
    },
    toast: {
      bgColor: "#ffffff",
    ...
    cartLanding: {
      ...
      headerTextColor: "#1c1917",
      headerCloseColor: "#a8a29e",
      headerIconColor: "#0d9488",
      itemBgColor: "#ffffff",
      itemBorderColor: "#ccfbf1",
      itemNameColor: "#1c1917",
      itemPriceColor: "#0d9488",
      itemTrashColor: "#dc2626",
      qtyBtnBgColor: "#ccfbf1",
      qtyBtnTextColor: "#0d9488",
      qtyNumberColor: "#1c1917",
      obsBgColor: "#ffffff",
      obsBorderColor: "#ccfbf1",
      obsTextColor: "#78716c",
      totalLabelColor: "#78716c",
      totalValueColor: "#0d9488",
      ctaBgColor: "#0d9488",
      ctaTextColor: "#ffffff",
      clearLinkColor: "#dc2626",
    },
    ...
    reviews: {
      headline: "O que dizem os donos dos pets",
      isVisible: true,
      starColor: "#0d9488",
      label: "AVALIAÇÕES",
      labelFont: "Quicksand",
    ...
    info: {
      ...
      headlineFontWeight: "700",
      headlineColor: "#1c1917",
      subheadline: "Seu pet merece o melhor atendimento",
      subheadlineFont: "Quicksand",
      subheadlineFontSize: 18,
      subheadlineFontWeight: "500",
      subheadlineColor: "#78716c",
      headline1: "Venha nos Visitar",
      subheadline1: "Seu pet merece o melhor atendimento",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 20,
      mapPinColor: "#0d9488",
      mapBtnBgColor: "#0d9488",
      mapBtnTextColor: "#ffffff",
      mapBtnFont: "Quicksand",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "600",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#0d9488",
      addressIconBgColor: "#ccfbf1",
      addressTitleColor: "#1c1917",
      addressTextColor: "#78716c",
      addressFont: "Quicksand",
      addressFontSize: 14,
      addressFontWeight: "400",
      phoneIconColor: "#0d9488",
      phoneIconBgColor: "#ccfbf1",
      phoneTitleColor: "#1c1917",
      phoneTextColor: "#78716c",
      phoneFont: "Quicksand",
      phoneFontSize: 14,
      phoneFontWeight: "400",
      hoursIconColor: "#0d9488",
      hoursIconBgColor: "#ccfbf1",
      hoursTitleColor: "#1c1917",
      hoursContentColor: "#78716c",
      hoursLinkColor: "#0d9488",
      hoursLinkFont: "Quicksand",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "500",
      scheduleModalBg: "#ffffff",
      scheduleModalTitleColor: "#1c1917",
      scheduleModalTextColor: "#78716c",
      scheduleModalStatusColor: "#16a34a",
      scheduleModalHighlightBg: "#ccfbf1",
      socialBtnBgColor: "#ccfbf1",
    ...
    sectionColors: {},
    whatsapp: {
      popupTitle: "Dúvidas sobre seu pet?",
...
// ============================================
// PRESET 23 — LOJA DE ROUPAS (Fashion Noir)
// ============================================

const lojaDeRoupas: DesignPreset = {
  id: "loja-de-roupas",
  name: "Fashion Noir",
  description: "Preto minimalista com acentos brancos. Moda e sofisticação.",
  niche: "Loja de roupas, moda, acessórios, calçados",
  colors: { primary: "#ffffff", background: "#09090b", accent: "#18181b" },
  themeColors: {
    primary: "#ffffff",
    background: "#09090b",
    foreground: "#fafafa",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(9,9,11,0.8)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(255,255,255,0.05)",
      locationBoxText: "#a1a1aa",
      locationBoxIcon: "#ffffff",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      ...
      badgeOpenColor: "#22c55e",
      badgeClosedColor: "#ef4444",
      headline: "Nova Coleção Disponível",
      headlineFont: "Outfit",
      headlineFontSize: 64,
      headlineFontWeight: "300",
      headlineColor: "#fafafa",
      subheadline: "Estilo que define quem você é",
      ...
      ctaTextColor: "#09090b",
      ctaGradient: false,
      ctaGradientEnd: "#e4e4e7",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 50,
      bgOverlayColor: "#09090b",
      bgFallbackColor: "#09090b",
    },
    products: {
      headline: "Coleção",
      subheadline: "Peças selecionadas para você",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Outfit",
      headlineFontSize: 40,
      ...
      cardBgColor: "#18181b",
      cardNameColor: "#fafafa",
      cardPriceColor: "#e4e4e7",
      cardDescColor: "#a1a1aa",
      cardUnitColor: "#71717a",
      cardBorderRadius: 4,
      cardBorderColor: "#27272a",
      cardBorderWidth: 1,
      cardButtonText: "Comprar",
      cardButtonBgColor: "#ffffff",
      cardButtonTextColor: "#09090b",
      bgColor: "#09090b",
      bgGradient: false,
    ...
    about: {
      preHeadline: "SOBRE A MARCA",
      preHeadlineFont: "Outfit",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "400",
      preHeadlineColor: "#a1a1aa",
      headline: "Nossa Essência",
      headlineFont: "Outfit",
      headlineFontSize: 48,
      headlineFontWeight: "300",
      headlineColor: "#fafafa",
      imageRadius: 4,
      ownerNameFont: "Outfit",
      ownerNameFontSize: 20,
      ownerNameFontWeight: "500",
      ownerNameColor: "#fafafa",
      ownerTitleColor: "#a1a1aa",
      storytellingFont: "Outfit",
      storytellingFontSize: 18,
      storytellingFontWeight: "300",
      storytellingColor: "#d4d4d8",
    ...
    menu: {
      menuSectionTitle: "Catálogo",
      panelBgColor: "#09090b",
      panelOverlayOpacity: 85,
      panelOverlayColor: "#09090b",
      headerTextColor: "#fafafa",
      searchBorderColor: "#27272a",
      ...
      filterActiveBgColor: "#ffffff",
      filterActiveTextColor: "#09090b",
      filterInactiveBgColor: "#27272a",
      filterInactiveTextColor: "#a1a1aa",
      cardBgColor: "#18181b",
      cardBorderColor: "#27272a",
      ...
      modalNameColor: "#fafafa",
      modalUnitColor: "#71717a",
      modalPriceColor: "#e4e4e7",
      modalDescColor: "#a1a1aa",
      modalCtaBgColor: "#ffffff",
      modalCtaTextColor: "#09090b",
      modalCtaFont: "Outfit",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "400",
      qtyLabelColor: "#a1a1aa",
      qtyBtnBgColor: "#27272a",
      qtyBtnTextColor: "#fafafa",
      qtyNumberColor: "#fafafa",
    ...
    reviews: {
      headline: "Nossos clientes recomendam",
      isVisible: true,
      starColor: "#ffffff",
      label: "REVIEWS",
      labelFont: "Outfit",
    ...
    info: {
      ...
      labelFontWeight: "400",
      labelColor: "#a1a1aa",
      headline: "Visite Nossa Loja",
      headlineFont: "Outfit",
      headlineFontSize: 40,
      headlineFontWeight: "300",
      headlineColor: "#fafafa",
      subheadline: "Experimente nossas peças pessoalmente",
      subheadlineFont: "Outfit",
      subheadlineFontSize: 18,
      subheadlineFontWeight: "300",
      subheadlineColor: "#a1a1aa",
      headline1: "Visite Nossa Loja",
      subheadline1: "Experimente nossas peças pessoalmente",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 50,
      mapPinColor: "#ffffff",
      mapBtnBgColor: "#ffffff",
      mapBtnTextColor: "#09090b",
      mapBtnFont: "Outfit",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "400",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#ffffff",
      addressIconBgColor: "#27272a",
      addressTitleColor: "#fafafa",
      addressTextColor: "#a1a1aa",
      addressFont: "Outfit",
      ...
      hoursTitleColor: "#fafafa",
      hoursContentColor: "#a1a1aa",
      hoursLinkColor: "#ffffff",
      hoursLinkFont: "Outfit",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "400",
      scheduleModalBg: "#18181b",
      scheduleModalTitleColor: "#fafafa",
      scheduleModalTextColor: "#a1a1aa",
      scheduleModalStatusColor: "#22c55e",
      scheduleModalHighlightBg: "#27272a",
    ...
    sectionColors: {},
    whatsapp: {
      popupTitle: "Precisa de ajuda com tamanhos?",
...
// ============================================
// PRESET 24 — MATERIAIS DE CONSTRUÇÃO (Builder Yellow)
// ============================================

const materiaisConstrucao: DesignPreset = {
  id: "materiais-construcao",
  name: "Builder Pro",
  description: "Amarelo industrial com fundo escuro. Robusto e profissional.",
  niche: "Materiais de construção, ferramentas, elétrica",
  colors: { primary: "#eab308", background: "#1c1917", accent: "#292524" },
  themeColors: {
    primary: "#eab308",
    background: "#1c1917",
    foreground: "#fafaf9",
  ...
  design: {
    home: {
      logoType: "text",
      logoSize: 80,
      headerBgColor: "rgba(28,25,23,0.9)",
      headerBehavior: "always_visible",
      locationBoxBg: "rgba(234,179,8,0.1)",
      locationBoxText: "#a8a29e",
      locationBoxIcon: "#eab308",
      locationLabel: "",
      locationBoxGlassmorphism: true,
      scheduleBoxBg: "rgba(34,197,94,0.15)",
      scheduleBoxText: "#22c55e",
      ...
      badgeOpenColor: "#22c55e",
      badgeClosedColor: "#ef4444",
      headline: "Tudo para Sua Obra",
      headlineFont: "Roboto",
      headlineFontSize: 60,
      headlineFontWeight: "900",
      headlineColor: "#fafaf9",
      subheadline: "Materiais de qualidade com os melhores preços da região",
      subheadlineFont: "Roboto",
      subheadlineFontSize: 20,
      subheadlineFontWeight: "400",
      subheadlineColor: "#a8a29e",
      ctaText: "Ver Produtos",
      ctaBgColor: "#eab308",
      ctaTextColor: "#1c1917",
      ctaGradient: false,
      ctaGradientEnd: "#ca8a04",
      ctaAction: "#cardapio",
      bgMediaType: "image",
      bgOverlayOpacity: 60,
      bgOverlayColor: "#1c1917",
      bgFallbackColor: "#1c1917",
    },
    products: {
      headline: "Nossos Produtos",
      subheadline: "Qualidade e preço justo para sua obra",
      maxCategories: 3,
      offersCategoryId: null,
      headlineFont: "Roboto",
      headlineFontSize: 40,
      ...
      subheadlineColor: "#a8a29e",
      cardBgColor: "#292524",
      cardNameColor: "#fafaf9",
      cardPriceColor: "#eab308",
      cardDescColor: "#a8a29e",
      cardUnitColor: "#78716c",
      cardBorderRadius: 8,
      cardBorderColor: "#44403c",
      cardBorderWidth: 1,
      cardButtonText: "Orçar",
      cardButtonBgColor: "#eab308",
      cardButtonTextColor: "#1c1917",
      bgColor: "#1c1917",
      bgGradient: false,
      bgGradientFrom: "#1c1917",
      bgGradientTo: "#292524",
      bgGradientDirection: "to-b",
      bgOverlayOpacity: 0,
      bgOverlayColor: "#000000",
      viewAllBgColor: "transparent",
      viewAllTextColor: "#eab308",
      viewAllFont: "Roboto",
      viewAllFontSize: 14,
      viewAllFontWeight: "600",
      viewAllLabel: "Ver todos",
    ...
    about: {
      preHeadline: "SOBRE A LOJA",
      preHeadlineFont: "Roboto",
      preHeadlineFontSize: 14,
      preHeadlineFontWeight: "700",
      preHeadlineColor: "#eab308",
      headline: "Nossa Trajetória",
      headlineFont: "Roboto",
      headlineFontSize: 48,
      headlineFontWeight: "900",
      headlineColor: "#fafaf9",
      imageRadius: 8,
      ownerNameFont: "Roboto",
      ownerNameFontSize: 20,
      ownerNameFontWeight: "700",
      ownerNameColor: "#fafaf9",
      ownerTitleColor: "#a8a29e",
      storytellingFont: "Roboto",
      storytellingFontSize: 18,
      storytellingFontWeight: "400",
      storytellingColor: "#d6d3d1",
    ...
    menu: {
      ...
      panelBgColor: "#1c1917",
      panelOverlayOpacity: 80,
      panelOverlayColor: "#1c1917",
      headerTextColor: "#fafaf9",
      searchBorderColor: "#44403c",
      searchBgColor: "#292524",
      searchTextColor: "#fafaf9",
      searchPlaceholderColor: "#78716c",
      searchIconColor: "#78716c",
      categoryNameColor: "#eab308",
      filterActiveBgColor: "#eab308",
      filterActiveTextColor: "#1c1917",
      filterInactiveBgColor: "#44403c",
      filterInactiveTextColor: "#a8a29e",
      cardBgColor: "#292524",
      cardBorderColor: "#44403c",
      cardBorderWidth: 1,
      cardBorderRadius: 8,
      ...
      cardButtonTextColor: "#1c1917",
      modalBgColor: "#292524",
      modalNameColor: "#fafaf9",
      modalUnitColor: "#78716c",
      modalPriceColor: "#eab308",
      modalDescColor: "#a8a29e",
      modalCtaBgColor: "#eab308",
      modalCtaTextColor: "#1c1917",
      modalCtaFont: "Roboto",
      modalCtaFontSize: 16,
      modalCtaFontWeight: "700",
      qtyLabelColor: "#a8a29e",
      qtyBtnBgColor: "#44403c",
      qtyBtnTextColor: "#fafaf9",
      qtyNumberColor: "#fafaf9",
    },
    toast: {
      bgColor: "#292524",
      borderColor: "#eab308",
      ...
      iconCheckColor: "#1c1917",
      iconBgColor: "#eab308",
      closeButtonColor: "#78716c",
    },
    cartLanding: {
      modalBgColor: "#1c1917",
      headerTextColor: "#fafaf9",
      headerCloseColor: "#78716c",
      headerIconColor: "#eab308",
      itemBgColor: "#292524",
      itemBorderColor: "#44403c",
      itemNameColor: "#fafaf9",
      itemPriceColor: "#eab308",
      itemTrashColor: "#ef4444",
      qtyBtnBgColor: "#44403c",
      qtyBtnTextColor: "#fafaf9",
      qtyNumberColor: "#fafaf9",
      obsBgColor: "#292524",
      obsBorderColor: "#44403c",
      obsTextColor: "#a8a29e",
      totalLabelColor: "#a8a29e",
      totalValueColor: "#eab308",
      ctaBgColor: "#eab308",
      ctaTextColor: "#1c1917",
      clearLinkColor: "#ef4444",
    },
    ...
    reviews: {
      ...
      headlineFontWeight: "900",
      headlineColor: "#fafaf9",
      ratingNumberColor: "#fafaf9",
      ratingTotalColor: "#78716c",
      cardBgColor: "#292524",
      cardNameColor: "#fafaf9",
      cardDateColor: "#78716c",
      cardTextColor: "#d6d3d1",
      ctaBgColor: "#eab308",
      ctaTextColor: "#1c1917",
      ctaFont: "Roboto",
      ctaFontSize: 14,
    ...
    info: {
      ...
      headlineFontWeight: "900",
      headlineColor: "#fafaf9",
      subheadline: "Atendimento especializado para sua obra",
      subheadlineFont: "Roboto",
      subheadlineFontSize: 18,
      subheadlineFontWeight: "400",
      subheadlineColor: "#a8a29e",
      headline1: "Visite Nossa Loja",
      subheadline1: "Atendimento especializado para sua obra",
      ctaText: "Como Chegar",
      mapOverlayOpacity: 40,
      mapPinColor: "#eab308",
      mapBtnBgColor: "#eab308",
      mapBtnTextColor: "#1c1917",
      mapBtnFont: "Roboto",
      mapBtnFontSize: 14,
      mapBtnFontWeight: "700",
      mapBtnLabel: "Como Chegar",
      addressIconColor: "#eab308",
      addressIconBgColor: "#44403c",
      addressTitleColor: "#fafaf9",
      addressTextColor: "#a8a29e",
      addressFont: "Roboto",
      addressFontSize: 14,
      addressFontWeight: "400",
      phoneIconColor: "#eab308",
      phoneIconBgColor: "#44403c",
      phoneTitleColor: "#fafaf9",
      phoneTextColor: "#a8a29e",
      phoneFont: "Roboto",
      phoneFontSize: 14,
      phoneFontWeight: "400",
      hoursIconColor: "#eab308",
      hoursIconBgColor: "#44403c",
      hoursTitleColor: "#fafaf9",
      hoursContentColor: "#a8a29e",
      hoursLinkColor: "#eab308",
      hoursLinkFont: "Roboto",
      hoursLinkFontSize: 14,
      hoursLinkFontWeight: "500",
      scheduleModalBg: "#292524",
      scheduleModalTitleColor: "#fafaf9",
      scheduleModalTextColor: "#a8a29e",
      scheduleModalStatusColor: "#22c55e",
      scheduleModalHighlightBg: "#44403c",
      socialBtnBgColor: "#44403c",
      socialIconColor: "#eab308",
      socialBtnTextColor: "#a8a29e",
      socialBtnShowText: false,
      socialInstagramEnabled: true,
      socialFacebookEnabled: true,
      socialYoutubeEnabled: true,
      sectionBgColor: "#1c1917",
      cardsBgColor: "#292524",
      bgOverlayOpacity: 0,
      bgOverlayColor: "#000000",
